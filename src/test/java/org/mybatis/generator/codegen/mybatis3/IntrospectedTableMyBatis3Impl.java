 ...
 * @author: lele
 * @date: 2022/12/1 8:13
 * @description: 重复执行自动生成代码工具类时，生成的mapper.xml文件内容是追加的，会报错。修改此文件后，每次生成新文件。
 * 用法：在mybatisGenerator.xml中的context标签中添加<property name="mergeAble" value="false"/>
 */
...
*/
             ...
             * 设置 mergeAble = false； 在生成 xml文件的时候，将不是合并，而是直接覆盖；
             * */
